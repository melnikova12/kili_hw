...
# 3.3 Первое вхождение (лемма): цысарить, цысарь
```
...
```
# 3.4 Ответ: потому что лексико-грам. поиск используется для поиска слов и словоформ, а баба с возу - фразеологизм (то есть не одно слово)
```
...
Запишите объем этого корпуса на момент поиска: 283 431 966
```
